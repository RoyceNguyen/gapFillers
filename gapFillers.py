#a program that finds all files with a given prefix in a single folder and locates any gaps in the numbering Have the program rename all the later files to close this gap.

import os
import re
import  shutil

path = input("Enter the absolute path of the folder you'd like to search: ")
